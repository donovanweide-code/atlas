...
export interface SportpaleisWebshopIntakeState {
  ...
  matches: {
    ...
    contentHash: string; revision?: number; projectionVersion?: string; itemCount?: number; status: "HUMAN_CHECK" | "ACCEPTED" | "DELETED"; orderId: string | null; reviewReasons: string[];
