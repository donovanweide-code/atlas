...
const domains = {
  orders: ["Orders", { view: "Bekijken", create: "Invoeren", edit: "Aanpassen", complete: "Afronden", delete: "Verwijderen" }],
  ...
  management: ["Beheer", { view: "Beheer bekijken", users: "Gebruikers beheren", presets: "Presets beheren", permissions: "Rechten beheren", settings: "Instellingen beheren" }],
...
const semantics = { create_for_others: "create", reprint: "execute", history: "view", replace_source: "manage", reply: "send", send_supplier: "send", archive: "edit", manage_templates: "manage", add_asset: "create", users: "manage", presets: "manage", permissions: "manage", settings: "manage", propose: "create" };
...
const employee = ["orders.view", "orders.create"];
const production = [...employee, "orders.edit", "production.view", "production.create", "production.edit", "production.execute", "production.complete", "production.reprint", "production.history"];
