...
async function main() {
  ...
  const runtimeDependencies = await collectRuntimeDependencyGraph({
    ...
    entrypoints: [
      ...
      path.join(websiteRoot, "scripts", "sportpaleis-production-shaped-assurance.mjs"),
      path.join(websiteRoot, "scripts", "wbd-owner-domain-assurance.mjs"),
      path.join(websiteRoot, "scripts", "wbd-owner-domain-backfill.mjs"),
      path.join(websiteRoot, "scripts", "wbd-owner-domain-rollback-bridge.mjs"),
  ...
  const explicit = [
    ...
    [path.join(websiteRoot, "scripts", "release-baseline-policy.cjs"), "app/scripts/release-baseline-policy.cjs"],
    [path.join(websiteRoot, "scripts", "release-baseline-loader.mjs"), "app/scripts/release-baseline-loader.mjs"],
    [path.join(websiteRoot, "scripts", "release-baseline-collector.mjs"), "app/scripts/release-baseline-collector.mjs"],
