...
test("semantische garmentzone en exacte approved geometrie blijven afzonderlijk dezelfde compositiewaarheid", () => {
  const [item] = normalizeProposalItems([{ id: "shirt", articleId: "server-known-shirt", productName: "Wedstrijdshirt", color: "Zwart", catalogSnapshot: { catalogProductId: "server-known-shirt", brand: "Testmerk", supplierName: "Testleverancier", supplierArticleName: "Wedstrijdshirt", supplierArticleNumber: "TEST-SHIRT", category: "Shirt", colorLabel: "Zwart", imageKey: "test-shirt-front", sourceAdapterId: "test-server-catalog", sourceStatus: "AUTHORITATIVE", productType: "UPPER_GARMENT", printableSides: ["FRONT", "BACK"], canonicalProductIdentity: { version: "TEAMKIT_CANONICAL_PRODUCT_IDENTITY_V1", sourceArticleId: "server-known-shirt", articleNumber: "TEST-SHIRT", productType: "UPPER_GARMENT", physicalSides: ["FRONT", "BACK"], printableSides: ["FRONT", "BACK"], authority: "TEST_SERVER_PRODUCT_TRUTH", evidenceKind: "TEST_FIXTURE", evidenceReference: "final-council-r20", evidenceHash: "A".repeat(64) } }, placements: [{ id: "logo", kind: "CLUB_LOGO", label: "Clublogo", side: "FRONT", preset: "LINKERBORST", sourceId: "source-logo", productionAssetId: null, widthPercent: 23, visualPosition: { coordinateSpace: "GARMENT_PRINT_AREA_V1", xPercent: 41.25, yPercent: 32.5 }, route: "NOG_TE_BEPALEN" }] }]);
